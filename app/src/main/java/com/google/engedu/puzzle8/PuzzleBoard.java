...
public class PuzzleBoard {
        ...
        for (int y = 0; y < NUM_TILES; y++) {
            for (int x = 0; x < NUM_TILES; x++) {
...

                {
                    ...
                    Bitmap tileBitmap = Bitmap.createBitmap(scaledBitmap, x * tileSize, y * tileSize, tileSize, tileSize);
    ...
    PuzzleBoard(PuzzleBoard otherBoard, int stepNumber) {
        prevousBoard = otherBoard;
        // tiles=(ArrayList<PuzzleTile>)otherBoard.tiles
    ...
    public ArrayList<PuzzleBoard> neighbours() {
        ...
        for (int[] coordinates : NEIGHBOUR_COORDS) {
            ...
            if (neighbourX >= 0 && neighbourX < NUM_TILES && neighbourY >= 0 && neighbourY < NUM_TILES) {
                PuzzleBoard neigbourBoard = new PuzzleBoard(this, stepNumber);
    ...
    private PuzzleBoard prevousBoard;

    public PuzzleBoard getPrevousBoard() {
        return prevousBoard;
    }

    public void setPrevousBoard(PuzzleBoard prevousBoard) {
        this.prevousBoard = prevousBoard;
    }
}
